    ...
    setPoints((prev) =>
      prev.map((point) =>
        point.id === activePointId
          ? {
              ...point,
              specification: tempSpecification.trim() || "Sin especificación",
            }
          : point
      )
    );
            ...
            {points.filter((p) => p.specification).length === 0 ? (
              <div className="p-4 text-center text-muted-foreground">
                ...
                <p className="text-xs mt-1">
                  Haz clic en la imagen para añadir
                </p>
              </div>
            ) : (
              <div className="p-4 space-y-4">
                {points
                  ...
                  .map((point, index) => (
                    <div
                      key={point.id}
                      className="p-3 rounded-lg bg-muted/30 relative"
                    >
